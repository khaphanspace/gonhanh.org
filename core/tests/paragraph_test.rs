...
#[test]
fn telex_full_paragraph() {
    telex(&[(TELEX_INPUT, EXPECTED_OUTPUT)]);
}

#[test]
fn vni_full_paragraph() {
    vni(&[(VNI_INPUT, EXPECTED_OUTPUT)]);
}
