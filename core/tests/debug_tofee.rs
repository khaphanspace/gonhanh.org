...
#[test]
fn debug_tofee() {
    // Test "tofee" - t+o+f+e+e → 'o' gets huyền, then 'ee' should NOT become ê
    // Expected: "tòee" (keep Vietnamese transformation)
    let keys_seq = [keys::T, keys::O, keys::F, keys::E, keys::E];
